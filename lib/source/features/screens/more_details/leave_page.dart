...
class _LeaveScreenState extends State<LeaveScreen> {
  ...
  cancelLeave(driverLeaveId) {
    cancelLeaveModel = NetworkHelper()
        .cancelDriverLeaveAPI(context: context, driverLeaveId: driverLeaveId);

    return cancelLeaveModel;
  }

  getLeaveHistory({selectedYear, selectedMonth}) {
    leaveHistoryModel = NetworkHelper().leaveHistoryAPI(
        context: context,
  ...
  void initState() {
    ...
    // currentLeaveHistoryModel = NetworkHelper()
    //     .appliedLeaveAPI(context: context, driverId: widget.driverId);
  }
              ...
              Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: FutureBuilder(
                        future: NetworkHelper().appliedLeaveAPI(context: context,driverId:widget.driverId.toString()),
                        builder:
                            (context, AsyncSnapshot<AppliedLeaveModel?> snapshot) {
                          if (snapshot.hasData) {
                                    ...
                                    return Dismissible(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            color:
                                            snapshot.data!.data![index].leaveStatus=="1"?
                                                Colors.green.shade100:
                                            snapshot.data!.data![index].leaveStatus=="2"?
                                            Colors.yellow.shade200:
                                            snapshot.data!.data![index].leaveStatus=="3"?
                                                  ...
                                                  child: RichText(
                                                    text: TextSpan(
                                                        ...
                                                        children: [
                                                          TextSpan(
                                                              text:
                                                                  "${DateFormat('dd MMM yy ').format(DateTime.parse(snapshot.data!.data![index].createdAt!)).toUpperCase()} | ${DateFormat('hh:mm a').format(DateTime.parse(snapshot.data!.data![index].createdAt!)).toUpperCase()}",
                                                              style: TextStyle(
                                                                  color: Colors
                                                                      .yellow
                                                                      .shade700)),
                  ...
                  SizedBox(
                    ...
                    child: FutureBuilder(
                        future: NetworkHelper().leaveHistoryAPI(
                            context: context,
                            year: DateTime.now().year,
                            month: DateTime.now().month,
                            driverId: widget.driverId.toString()),
                        builder:
                            (context, AsyncSnapshot<LeaveHistoryModel?> snapshot) {
                          if (snapshot.hasData) {
                            if (snapshot.data!.data!.length == 0) {
                              return Center(
                                  child: Column(
