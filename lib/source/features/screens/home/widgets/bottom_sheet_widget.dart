...
class _BottomSheetWidgetState extends State<BottomSheetWidget> {
  ...
  Future<StartTripModel?>? startTrip() async {
    startTripModel = NetworkHelper().startDriverTripApi(
        context: context, bookingId: widget.bookingId, tripStartBy: "");
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    ...
                                    style: TextStyle(
                                        color: widget.vehType.toString() ==
                                                "Manual"
                                            ? Colors.blue
                                            : widget.vehType.toString() ==
                                                    "Automatic"
                                                ? Colors.red
                                                : Colors.green,
                                        fontWeight: FontWeight.w500,
