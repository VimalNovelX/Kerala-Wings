...
class _MoreDetailsScreenState extends State<MoreDetailsScreen> {
        ...
        appBar: AppBar(
          ...
          actions: [
            Container(
              ...
              child: Center(
                  child: buildRichText("MORE ", " INFORMATION", 12,
                      Colors.white, cPrimaryColor)),
            )
          ],
        ),
        body: SafeArea(
  ...
  RichText buildRichText(
      String text1, String text2, double size, color, color1) {
    return RichText(
      text: TextSpan(
          text: text1,
          style: TextStyle(
              color: color1, fontWeight: FontWeight.w600, fontSize: size),
          children: [
            TextSpan(
              text: text2,
              style: TextStyle(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage('assets/images/qrCode.jpeg')),
